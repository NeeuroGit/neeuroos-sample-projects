...
/// Returns the  authentication validity period remaining
...
+ (void) BLE_SetSenzeBandVersion:(DelegateSDK) callbackNFL;
...
+ (void) FNFL_EEG_GetFreqTypePowerNormReref:(DelegateSDK) callbackNFL;
+ (void) FNFL_EEG_GetData:(DelegateSDK) callbackNFL;
+ (void) FNFL_EEG_GetData200ms:(DelegateSDK) callbackNFL;
...
+ (void) FNFL_commandACK:(DelegateSDK)callbackNFL;
...
/// For internal usage
@property (nonatomic,strong) id delegateIOS;
